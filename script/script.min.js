...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MainLayout = __webpack_require__(229);

	var _InitialPage = __webpack_require__(242);

	var _People = __webpack_require__(243);

	var _ContactsComponent = __webpack_require__(244);

	var _ProjectsContainerComponent = __webpack_require__(245);
	...
	(0, _reactDom.render)(_react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(_reactRouter.IndexRoute, { component: _InitialPage.InitialPage }),
	      _react2.default.createElement(_reactRouter.Route, { path: 'About', component: _People.PeopleComponent }),
	      _react2.default.createElement(_reactRouter.Route, { path: 'Projects', component: _ProjectsContainerComponent.ProjectsContainerComponent }),
	      _react2.default.createElement(_reactRouter.Route, { path: 'Contacts', component: _ContactsComponent.ContactsComponent })
	    )
	  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NavBarDesktopComponent = __webpack_require__(232);

	var _NavBarMobileComponent = __webpack_require__(233);
	...
	var NavBar = exports.NavBar = function (_React$Component) {
	  ...
	  function NavBar() {
	    ...
	    var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(NavBar).call(this));
	    ...
	    _this2.forceClose = _this2.forceClose.bind(_this2);
	    _this2.state = {
	      NavBarClasses: "navbar navbar-fixed",
	      PrevY: 0,
	      lowered: false,
	      transitioning: false
	    };
	  ...
	  _createClass(NavBar, [{
	    ...
	    value: function handleScroll(event) {
	      ...
	      if (yPosition < this.state.PrevY) {
	        ...
	        if (this.state.lowered === true) {
	          _this.forceClose();
	          _this.setState({
	            NavBarClasses: "navbar navbar-fixed navbar-up-animation"
	          });
	        }
	      }
	      this.setState({
	    ...
	    key: 'handleClick',
	    value: function handleClick(thing) {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: this.state.NavBarClasses },
	        _react2.default.createElement(_Button.Button, { click: this.forceClose, image: true, linkTo: '/', data: './images_prod/LogoWhite.svg' }),
	        _react2.default.createElement(_NavBarDesktopComponent.NavBarDesktopComponent, null),
	        _react2.default.createElement(_NavBarMobileComponent.NavBarMobileComponent, { open: this.state.open, handleClick: this.handleClick })
	      );
	    }
	  }]);
	...
	var Button = exports.Button = function (_React$Component) {
	  ...
	  _createClass(Button, [{
	    ...
	    value: function handleClick(event) {
	      ...
	      var element = this.refs[this.props.linkTo];
	      var circle = document.createElement("div");
	      var elementPosition = element.getBoundingClientRect();
	      //10 px need to be removed from each axis
	      var x = event.clientX - 10 - elementPosition.x;
	      var y = event.clientY - 10 - elementPosition.y;
	  ...
	  _createClass(Button, [{
	    ...
	    value: function render() {
	      var element = void 0;
	      var buttonClasses = "navbar--button ";
	      if (!this.props.image) element = _react2.default.createElement(
	        'p',
	        { className: 'navbar--button--text' },
	        this.props.data
	      );else element = _react2.default.createElement('img', { src: this.props.data, className: 'navbar--button--image' });
	      if (this.props.mobile === true) buttonClasses += "navbar--button--mobile";
	      if (this.props.outsideLink) {
	        return _react2.default.createElement(
	          'a',
	          { href: this.props.linkTo, onClick: this.handleClick },
	          _react2.default.createElement(
	            'div',
	            { className: buttonClasses, ref: this.props.linkTo },
	            element
	          )
	        );
	      } else {
	        return _react2.default.createElement(
	          _reactRouter.Link,
	          { to: this.props.linkTo, onClick: this.handleClick },
	          _react2.default.createElement(
	            'div',
	            { className: buttonClasses, ref: this.props.linkTo },
	            element
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.NavBarDesktopComponent = undefined;
	...
	var NavBarDesktopComponent = exports.NavBarDesktopComponent = function (_React$Component) {
	  _inherits(NavBarDesktopComponent, _React$Component);

	  function NavBarDesktopComponent() {
	    _classCallCheck(this, NavBarDesktopComponent);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(NavBarDesktopComponent).apply(this, arguments));
	  }

	  _createClass(NavBarDesktopComponent, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'navbar--desktop' },
	        _react2.default.createElement(_Button.Button, { image: false, linkTo: '/About', data: 'People' }),
	        _react2.default.createElement(_Button.Button, { image: false, linkTo: '/Projects', data: 'Projects' }),
	        _react2.default.createElement(_Button.Button, { image: false, linkTo: '/Contacts', data: 'Contacts' }),
	        _react2.default.createElement(_Button.Button, { outsideLink: true, image: false, linkTo: '/blog', data: 'Blog' })
	      );
	    }
	  }]);

	  return NavBarDesktopComponent;
	}(_react2.default.Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.NavBarMobileComponent = undefined;
	...
	var _NavBarMobileTap = __webpack_require__(234);
	...
	var NavBarMobileComponent = exports.NavBarMobileComponent = function (_React$Component) {
	  _inherits(NavBarMobileComponent, _React$Component);

	  function NavBarMobileComponent() {
	    _classCallCheck(this, NavBarMobileComponent);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(NavBarMobileComponent).apply(this, arguments));
	  }

	  _createClass(NavBarMobileComponent, [{
	    key: 'render',
	    value: function render() {
	      var dropDownClasses = "navbar--mobile ";
	      if (this.props.open === 1) dropDownClasses += "navbar--mobile-open";
	      return _react2.default.createElement(
	        'div',
	        { className: dropDownClasses },
	        _react2.default.createElement(_NavBarMobileTap.NavBarMobileTap, { click: this.props.handleClick, open: this.props.open }),
	        _react2.default.createElement(_Button.Button, { image: false, click: this.props.handleClick, mobile: true, linkTo: '/About', data: 'People' }),
	        _react2.default.createElement(_Button.Button, { image: false, click: this.props.handleClick, mobile: true, linkTo: '/Projects', data: 'Projects' }),
	        _react2.default.createElement(_Button.Button, { image: false, click: this.props.handleClick, mobile: true, linkTo: '/Contacts', data: 'Contacts' }),
	        _react2.default.createElement(_Button.Button, { outsideLink: true, image: false, click: this.props.handleClick, mobile: true, linkTo: '/blog', data: 'Blog' })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.NavBarMobileTap = undefined;
	...
	var NavBarMobileTap = exports.NavBarMobileTap = function (_React$Component) {
	  _inherits(NavBarMobileTap, _React$Component);

	  function NavBarMobileTap() {
	    _classCallCheck(this, NavBarMobileTap);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(NavBarMobileTap).apply(this, arguments));
	  }

	  _createClass(NavBarMobileTap, [{
	    key: "render",
	    value: function render() {
	      var tapStyles = "Mobile-Tap-Target";
	      var divStyles = "Mobile-Div";
	      ...
	      return _react2.default.createElement(
	        "div",
	        { className: tapStyles, onClick: this.props.click },
	        _react2.default.createElement("div", { className: divStyles }),
	        _react2.default.createElement("div", { className: divStyles }),
	        _react2.default.createElement("div", { className: divStyles })
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InitialPage = exports.InitialPage = function (_React$Component) {
	  _inherits(InitialPage, _React$Component);

	  function InitialPage() {
	    _classCallCheck(this, InitialPage);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(InitialPage).call(this));

	    _this.generate_shadow = _this.generate_shadow.bind(_this);
	    return _this;
	  }

	  _createClass(InitialPage, [{
	    key: "generate_shadow",
	    value: function generate_shadow(length, b_dif, color) {
	      var strng = "";
	      var b = 1;
	      if (length > 0) {
	        ...
	        b = 5;
	        for (var _a = 0; _a >= length; _a -= 2) {
	          strng += _a + "px " + b + "px 0 " + color;
	          if (_a > length) {
	            strng += ",";
	          }
	          b += b_dif;
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "p",
	            { className: "initial--text", style: { textShadow: this.generate_shadow(1200, 1, "#4B0082") } },
	            "Alpha"
	          ),
	          _react2.default.createElement(
	            "p",
	            { className: "initial--text", style: { textShadow: this.generate_shadow(1200, 1, "#3b0066") } },
	            "Dev"
	          )
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.PeopleComponent = undefined;
	...
	var Person = function (_React$Component) {
	  ...
	  _createClass(Person, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        "a",
	        { href: this.props.link, className: "people--person" },
	        _react2.default.createElement(
	          "div",
	          { className: "people--person--spacer" },
	          _react2.default.createElement("img", { className: "img", src: this.props.pic })
	        ),
	        _react2.default.createElement(
	          "div",
	          { className: "people--person--spacer" },
	...
	var PeopleComponent = exports.PeopleComponent = function (_React$Component2) {
	  _inherits(PeopleComponent, _React$Component2);

	  function PeopleComponent() {
	    _classCallCheck(this, PeopleComponent);

	    var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(PeopleComponent).call(this));

	    _this2.People = [{ "name": "Reed Krawiec", "job": "Front-End", "link": "https://reedkrawiec.github.io", "pic": "https://avatars1.githubusercontent.com/u/12550372?v=3&s=460" }, { "name": "Andros Yang", "job": "Back-End", "link": "http://mimerme.github.io", "pic": "https://avatars1.githubusercontent.com/u/6308253?v=3&s=400" }];
	    return _this2;
	  }
	  ...
	  _createClass(PeopleComponent, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        this.People.map(function (arr_element) {
	          return _react2.default.createElement(Person, { name: arr_element.name, link: arr_element.link, pic: arr_element.pic, job: arr_element.job });
	        })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContactsComponent = exports.ContactsComponent = function (_React$Component) {
	  _inherits(ContactsComponent, _React$Component);

	  function ContactsComponent() {
	    _classCallCheck(this, ContactsComponent);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ContactsComponent).apply(this, arguments));
	  }
	  ...
	  _createClass(ContactsComponent, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        "form",
	        { action: "https://formspree.io/reedkrawiec@gmail.com",
	          method: "POST", className: "contactform--container" },
	        _react2.default.createElement(
	          "div",
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement("textarea", { name: "Message", rows: "5" })
	          ),
	          _react2.default.createElement("input", { className: "contactform--submit", type: "submit", value: "Submit" })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ProjectsContainerComponent = undefined;
	...
	var ProjectsContainerComponent = exports.ProjectsContainerComponent = function (_React$Component) {
	  _inherits(ProjectsContainerComponent, _React$Component);

	  function ProjectsContainerComponent() {
	    _classCallCheck(this, ProjectsContainerComponent);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ProjectsContainerComponent).apply(this, arguments));
	  }

	  _createClass(ProjectsContainerComponent, [{
	    key: "render",
	    value: function render() {
	      return _react2.default.createElement(
	        "div",
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement("img", { className: "img", src: "./images_prod/playlister.png" })
	          ),
	          _react2.default.createElement(
	            "p",
	            { className: "text" },
